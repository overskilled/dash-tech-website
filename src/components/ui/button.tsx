...
const buttonVariants = cva(
  "group/btn inline-flex items-center justify-center hover:cursor-pointer gap-2.5 whitespace-nowrap font-medium transition-all duration-500 ease-out disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive uppercase tracking-[0.08em]   bg-transparent text-primary relative overflow-hidden before:absolute before:inset-0 before:-translate-x-full before:animate-shimmer-out hover:before:translate-x-full hover:before:animate-shimmer-in before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:transition-transform before:duration-500 before:ease-in-out",
  {
    variants: {
      variant: {
        default:
